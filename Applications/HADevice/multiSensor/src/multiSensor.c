...
static void msBindingFinished(ClusterId_t clusterId);
static void handleMsConfigReporting(void);
...
typedef enum _msBoundClustersInEzMode_t
{
  OCCUPANCY_SENSING_CLUSTER_BOUND = (1 << 0),
  HUMIDITY_MEASUREMENT_CLUSTER_BOUND = (1 << 1),
  TEMPERATURE_MEASUREMENT_CLUSTER_BOUND = (1 << 2),
  ILLUMINANCE_MEASUREMENT_CLUSTER_BOUND = (1 << 3)
}msBoundClustersInEzMode_t;
...
typedef enum _ReportingState_t
{
  ...
  OCCUPANCY_SENSOR_REPORTING_CONFIGURED,
...
#ifdef APP_SENSOR_TYPE_OCCUPANCY_SENSOR
    if (msClustersBoundMask & OCCUPANCY_SENSING_CLUSTER_BOUND)
    {
...
#ifdef APP_SENSOR_TYPE_TEMPERATURE_SENSOR
    if (msClustersBoundMask & TEMPERATURE_MEASUREMENT_CLUSTER_BOUND)
    {
...
#ifdef APP_SENSOR_TYPE_HUMIDITY_SENSOR
    if (msClustersBoundMask & HUMIDITY_MEASUREMENT_CLUSTER_BOUND)
    {
...
#ifdef APP_SENSOR_TYPE_LIGHT_SENSOR
    if (msClustersBoundMask & ILLUMINANCE_MEASUREMENT_CLUSTER_BOUND)
    {
...
/**************************************************************************//**
\brief Binding finished indication function from ez mode manager

\param[out] bindInd - clusterId which is bound
******************************************************************************/
static void msBindingFinished(ClusterId_t clusterId)
{
  switch (clusterId)
  {
    ...
    case OCCUPANCY_SENSING_CLUSTER_ID:
      msClustersBoundMask |= OCCUPANCY_SENSING_CLUSTER_BOUND;
      break;
#endif
#ifdef APP_SENSOR_TYPE_TEMPERATURE_SENSOR
    case TEMPERATURE_MEASUREMENT_CLUSTER_ID:
      msClustersBoundMask |= TEMPERATURE_MEASUREMENT_CLUSTER_BOUND;
      break;
#endif
#ifdef APP_SENSOR_TYPE_HUMIDITY_SENSOR
    case HUMIDITY_MEASUREMENT_CLUSTER_ID:
      msClustersBoundMask |= HUMIDITY_MEASUREMENT_CLUSTER_BOUND;
      break;
#endif
#ifdef APP_SENSOR_TYPE_LIGHT_SENSOR
    case ILLUMINANCE_MEASUREMENT_CLUSTER_ID:
      msClustersBoundMask |= ILLUMINANCE_MEASUREMENT_CLUSTER_BOUND;
      break;
#endif
    default:
      break;

...
#define TMP_STRING_BUFFER_SIZE              180
// UART Tx buffer size
...
*******************************************************************************/
  ...
  typedef HAL_UsbHWDescriptor_t HAL_Descriptor_t;      // Usb descriptor (required by stack)
#else
  typedef  HAL_UsartDescriptor_t HAL_Descriptor_t;       // UART descriptor (required by stack)
#endif

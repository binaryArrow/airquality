...
static const ConsoleCommand_t cmds[] =
{
  ...
  {"matchDescReq", "dd",processMatchDescriptorRequestCmd,
    "-> Send MatchDescriptorRequest Command:[nwkAddr] [srcEp]\r\n"},
  {"simpleDescReq", "dd",processSimpleDescriptorRequestCmd, 
    "-> Send SimpleDescriptorRequest Command:[nwkAddr] [dstEp]\r\n"},
...
static void processGetAppDeviceTypeCmd(const ScanValue_t *args)
{
  ...
  appSnprintf(deviceFnStatusStr, HA_COMBINED_INTERFACE_ID);
  (void)args;
}
#ifndef ZAPPSI_HOST
/**************************************************************************//**

"""
@testcase
@description 2.4 TP-PRE-TC-04: Network start - ZED not factory new & ZR not factory new
...
writeLog("P4 Power on ED2 and R1")
powerOn([ed2, r1])

writeLog("P5 Initiate touchlink on ED2 with R1")
touchlink(ed2, r1)
idle([ed2, r1])

writeLog("P6 Power off ED2 and R1")
powerOff([ed2, r1])
...
writeLog("11c ZR1 leaves its previous network (Shall be checked by a sniffer)")
writeLog("11d ZR1 announces itself on the network (Shall be checked by a sniffer)")

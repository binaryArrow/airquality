"""
@testcase
@description 3.6 TP-CST-TC-06: Basic cluster with server as DUT
...
writeLog("2 Client sends read attribute command")
check(readBasicClusterAttribute(client1, ZCL_BASIC_CLUSTER_SERVER_ZCL_VERSION_ATTRIBUTE_ID) == 0x01)
readBasicClusterAttribute(client1, ZCL_BASIC_CLUSTER_SERVER_POWER_SOURCE_ATTRIBUTE_ID)

writeLog("3 Client sends write attribute command")
writeBasicClusterAttribute(client1, ZCL_BASIC_CLUSTER_SERVER_HW_VERSION_ATTRIBUTE_ID, ZCL_U8BIT_DATA_TYPE_ID, 0x0A, retStatus = ZCL_READ_ONLY_STATUS)

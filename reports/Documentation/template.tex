...
\begin{document}
	...
	\section{Lösungsansatz} %detaillierte beschreibung der einzelnen Aufgaben, probleme und Lösungen
		...
		\subsection{CCS811}
			...
			Zu Beginn wurden die Mockdaten in einem JSON-Format durch eine Python-Applikation erstellt um die Datenübertragung an die Datenbank testen zu können. Zwar hat dies funktioniert, doch wurde nach kurzer Zeit festgestellt, dass das nicht der beste Lösungsansatz war. Da die Daten von einem Sensor empfangen werden sollten, wurde entschieden ein C-Programm auf ein ZigBee-Modul zu programmieren, welches lediglich einen String mit einer bestimmten Anzahl an Werten abschickt, um die Übertragung von Sensordaten zu simulieren. 

...
\begin{document}
	...
	Zu Beginn des Projektes wurde entschieden die Aufgaben in zwei Teile aufzuteilen, einerseits in einen Sensorteil und andererseits in einen Applikationsteil. Es wurde festgelegt, dass Herr Merkert, Herr Just und Herr Glaesmann für die Einrichtung und Programmierung der Sensoren zuständig sind, während Herr Knez, Herr Nazlier und Herr Konieczka für die Einrichtung eines Servers und die Entwicklung der Applikation zuständig sind. 
		...
		\subsection{Stipe Knez}
			Kommunikation zwischen ZigBee Modulen und Backend, durch Integration von Serialport.js sowie Teile des Dashboards: Funktion
		...
		\subsection{Max-Rene Konieczka}
			Zu Anfang des Projekts musste sich Herr Konieczka, wie Herr Knez, das Basiswissen zu Vue aneignen, daher waren die ersten Wochen hauptsächlich mit Recherche bedeckt. % umformulieren
			Nachdem dies erfolgt ist, hat er sich um die Erstellung von Modalen gekümmert und das Dashboard eingerichtet; Ampel
		\subsection{Can Cihan Nazlier}
			Herr Nazlier hat sich zum einen um die Einrichtung der Programmierumgebung gekümmert. Dazu gehören die Erstellung eines GitHub-Repository und die Integrierung von Vue, einem JavaScript-Framework. Darüber hinaus hat er sich um die Integrierung einer Datenbank, die Programmierung des Sketchingboards sowie einige Teile des Dashboards gekümmert; Schnittstelle
